...
def to_csv():
    with open('data/pancake_'+str(count)+'.csv', 'w') as f:
        writer = csv.writer(f)
    ...
    with open('data/pancake_eigen_'+str(count)+'.csv', 'w') as f:
        writer = csv.writer(f)
